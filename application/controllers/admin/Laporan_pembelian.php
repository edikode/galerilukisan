...
class Laporan_pembelian extends CI_Controller{
    ...
    function index()
    {
        ...
        $data['laporan'] = $this->Pembelian_model->data_laporan($data['keyword'],$data['bulan'],$data['tahun']);

        $data['_view'] = 'admin/laporan/laporan_pembelian';
    ...
    public function cetak($keyword,$bulan,$tahun)
    {
        ...
        $data['laporan'] = $this->Pembelian_model->data_laporan($keyword,$bulan,$tahun);
        ...
        $this->load->view('pdf/laporan_pembelian',$data);
        ...
        $this->dompdf->stream("Laporan_pembelian-".$data['bulan']."-".$tahun.".pdf", array('Attachment' => 0));
