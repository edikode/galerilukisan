		...
		<table>
			<tr>
				...
				<td>
					...
					<p align="justify">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
					Email Ini adalah bukti pembayaran untuk Invoice <?php echo $invoice; ?> yang telah dibayar pada <?php echo $this->fungsi->tanggal_id($tanggal); ?> dengan jumlah pembayaran <?php echo 'Rp. '.number_format($total, 0, ',', '.'); ?>,-.
					</p>

					<h3>Dapatkan Format PDF <a href="<?php echo site_url('cetak_pembayaran/cetak'.$pembelian_id) ?>">Klik Disini</a></h3>
