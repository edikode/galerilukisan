		...
		<table>
			<tr>
				...
				<td>
					...
					<p align="justify">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						ini adalah email pemberitahuan tentang pemesanan lukisan yang anda lakukan pada website kami <a href="<?php echo site_url(); ?>">Galeri Cahaya Pelangi</a>. Selanjutnya cek kembali detail pemesanan anda dibawah ini, jika sudah sesuai dengan pemesanan yang anda lakukan, berikutnya anda harus melakukan konfirmasi dengan melakukan pembayaran dan upload bukti pembayaran pada website kami <a href="<?php echo site_url('pembayaran#pemesanan'); ?>">Disini.</a></a>
					</p>
						...
						<tr>
							...
							<td colspan="2">
								<table id="customers">
								  ...
								  <tr>
								    <td valign="top">Deskripsi Lukisan</td>
								    <td><?php 
								    $kategori = $this->Kategori_model->detail_data($kategori_id);
								    $ukuran = $this->Ukuran_model->detail_data($ukuran_id);
								    echo 'Kategori: '.$kategori->nama; ?> <br>Ukuran: <?php echo $ukuran->ukuran; ?> Cm.<br>Berat: <?php echo $ukuran->berat; ?> Kg.</td>
								  </tr>
								  <tr>
								    <td>Jumlah Pesan</td>
								  ...
								  <tr>
								    <td>Total</td>
								    <td><?php echo 'Rp. '.number_format($harga*$jumlah, 0, ',', '.'); ?>,-</td>
								  </tr>
								  <tr>
									<td>Ongkir</td>
								  ...
								  <tr>
									<td>Total + Ongkir</td>
									<td><?php echo 'Rp. '.number_format($harga*$jumlah+$ongkir, 0, ',', '.'); ?>,-</td>
								  </tr>
