...
<div class="row">
    <div class="col-md-12">
        <h2 class="page-header" style="display: initial;">Pemesanan</h2>
                ...
                <tbody>
                    ...
                    foreach($pemesanan as $p){
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="<?php echo site_url('admin/pemesanan/edit/'.$p->id); ?>" class="btn btn-info btn-sm" title="Edit">
                                    <span class="fa fa-pencil"></span>
                                </a>
                                <a data-toggle="modal" data-target="#<?php echo $p->id ?>" title="Validasi admin" class="btn btn-warning btn-sm">
                                    <span class="fa fa-eye"></span>
                                </a>
                                <a href="<?php echo site_url('admin/pemesanan/hapus/'.$p->id); ?>" class="btn btn-danger btn-sm" title="Hapus">
                          ...
                          <div class="modal-dialog">
                            <div class="modal-content">
                              ...
                              <div class="modal-footer">
                                <?php if ($p->status == 3): ?>
                                    <a href="<?php echo site_url('admin/pemesanan/validasi/'.$p->id) ?>" class="btn btn-success pull-left">Validasi</a>
                                    <a href="<?php echo site_url('admin/pemesanan/nonvalidasi/'.$p->id) ?>" class="btn btn-danger">Tidak Valid</a>
                                <?php endif ?>
                              </div>
                            </div>
                          </div>
