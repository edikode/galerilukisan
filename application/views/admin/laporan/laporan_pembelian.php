...
<div class="row">
    <div class="col-md-12">
        <h2 class="page-header" style="display: initial;">Laporan Pembelian</h2>
...
<div class="card mb-3">
    <div class="card-header">
        <i class="fa fa-table"></i> Laporan Pembelian
    </div>
    <div class="card-body">
        <?php echo form_open('admin/laporan_pembelian','role="form" class="form-horizontal"'); ?>
            <div class="row">
                <div class="col-md-2">
                ...
                <div class="col-md-3">
                    ...
                    echo site_url('admin/laporan_pembelian/cetak/'.$keyword.'/'.$bulan.'/'.$tahun) ?>' style="margin-top: 30px; float: right;">
